  ...
  >
    ...
    >
      ...
      <nav class="header-bar__nav">
        ...
        >
          <HeaderHamburger :menuActiveFlag="menuActiveFlag" :theme="themeForHamburger" />
        </div>
...
import { sendGaMethods } from '@/mixins/masterBuilder'
import { fbBrowserResize } from '@/mixins/fbBrowserResize'
...
export default {
  ...
  methods: {
    ...
    checkAnchor() {
      if (this.$store.state.anchorList.length === 0) {
        this.isAtTop = true
